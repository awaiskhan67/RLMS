            ...
            <div class="container-fluid p-0 mt-5">
                <div class="card ">
                    <div class="card-body">
                        ...
                        <h3 class="text-muted text-center font-size-28"><b>Register</b></h3>
                        ...
                        <div class="p-3">
                            ...
                            @csrf
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-6">
                                        <input class="form-control" type="text" name="fname" value="{{ old('fname') }}"  placeholder="First Name">
                                        @error('fname')<li class="text-danger">{{ $message }}</li>@enderror
                                    </div>
                                    <div class="col-6">
                                        <input class="form-control" type="text" name="lname" value="{{ old('lname') }}"  placeholder="Last Name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        ...
                                        @error('password_confirmation')<li class="text-danger">{{ $message }}</li>@enderror
                                    </div>
                                </div>
