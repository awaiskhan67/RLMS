       ...
       <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Property Edite</h4>
        ...
        <div class="card"> 
           <div class="card-body"> 
             <form method="post" action="{{ route('property.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="id" value="{{ $property->id }}">  
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-2">
                                        ...
                                        <input class="form-control" type="text" name="serial"  value="{{ $property->serial_no }}" placeholder="00001"  readonly >
                                        @error('serial')<li class="text-danger">{{ $message }}</li>@enderror
                                    </div>
                                    <div class="col-md-5">
                                        <label>Enter property name</label>
                                        <input class="form-control" type="text" name="name"  value="{{ old('name', $property->name ) }}" placeholder="Enter property name">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <select class="form-control" name="category">
                                            ...
                                            <option value="{{ $row->id }}" @if($property->category_id  === $row->id ) selected @endif >{{ $row->name }}</option>
                                            @endforeach
                                            <option>villa</option>
                                        </select>
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control" type="text" name="district" value="{{ old('district',$property->district) }}" placeholder="Enter district">
                                    ...
                                    <div class="col-md-3">
                                        <label>Street</label>
                                        <input class="form-control" type="text" name="street" value="{{ old('street',$property->street) }}" placeholder="Enter street">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6"><br>
                                        ...
                                        <img class="rounded mx-auto d-block" alt="200x200" width="300" src="{{ (!empty($property->image)) ? asset('uploads/'.$property->image):asset('assets/images/small/property.png')  }}" data-holder-rendered="true" id="updateprofile">
                                    </div>

                                    <div class="col-md-6">
                                        <label>Short Description about property</label>
                                        <textarea class="form-control" name="description"  placeholder="Enter property description in short">{{ old('description' , $property->shortDes) }}</textarea> 
                                        @error('description')<li class="text-danger">{{ $message }}</li>@enderror
                                    </div>
                                </div><hr> 

                <div class="mt-3 d-flex justify-content-end">
                  <button class="btn-outline btn btn-primary" type="submit">Update user data</button>&nbsp;&nbsp;<a class="btn-outline btn btn-dark" href="{{ route('property') }}">Back</a>
                </div>
             </form>
           </div>
        </div>
