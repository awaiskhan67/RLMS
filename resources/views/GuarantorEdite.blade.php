       ...
       <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Gaurantor Edite</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Utility</a></li>
                            <li class="breadcrumb-item active">Update gaurantor</li>
                        </ol>
                    </div>
        ...
        <div class="card"> 
           <div class="card-body"> 
             <form method="post" action="{{ route('guarantor.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mt-4">
                             ...
                             <div class="row mt-4">
                                <div class="col-md-6">
                                     ...
                                     <img class="rounded mx-auto d-block" alt="200x200" width="300" src="{{ (!empty($property->image)) ? asset('uploads/'.$property->image):asset('assets/images/small/profile.png')  }}" data-holder-rendered="true" id="updateprofile">
                                </div>

                                <div class="col-md-6">

                                    <label>Address</label>
                                     <textarea class="form-control" name="address" placeholder="Enter address">{{ old('address', $property->address) }}</textarea>
                                     @error('address')<li class="text-danger">{{ $message }}</li>@enderror
                                </div>
                             </div><hr>

                        <div class="mt-3 d-flex justify-content-end">
                        <button class="btn-outline btn btn-primary" type="submit">Update user data</button>&nbsp;&nbsp;<a class="btn-outline btn btn-dark" href="{{ route('guarantor') }}">Back</a>
                        </div>
             </form>
           </div>
        </div>
