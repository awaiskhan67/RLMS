       ...
       <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Gaurantor</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Utility</a></li>
                            <li class="breadcrumb-item active">Gaurantor</li>
                        </ol>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link @if(!$errors->any()) active @endif" data-bs-toggle="tab" href="#profile1" role="tab">
                                ...
                                <span class="d-none d-sm-block">Guarantor List</span> 
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link @if($errors->any()) active @endif" data-bs-toggle="tab" href="#messages1" role="tab">
                                ...
                                <span class="d-none d-sm-block">Add new guarantor</span>   
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content p-3 text-muted">
                            ...
                            <table id="datatable" class="table table-bordered  dt-responsive table-hover" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('guarantor.edite', $row->id) }}"><i class="ri-edit-2-fill  text-primary" style="font-size: 20px;"></i></a>&nbsp;&nbsp;
                                                <a href="{{ route('guarantor.delete', $row->id) }}" onclick="return confirm('Are you sure you want to delete this Gaurantor?');"><i class="ri-delete-bin-fill  text-danger" style="font-size: 20px;"></i></a>
                                            </td>
                                        </tr>
                                            @php $i++  @endphp
                                        @endforeach
                        ...
                        <div class="tab-pane @if($errors->any()) active @endif" id="messages1" role="tabpanel">
                            <form method="post" action="{{ route('guarantor.add') }}" class="mt-6 space-y-6"  enctype="multipart/form-data">
                               @csrf
                                ...
                                <button class="btn-outline btn btn-primary" type="submit">Add Guarantor</button>&nbsp;&nbsp;<button class="btn-outline btn btn-dark" type="reset">Reset</button>
                                </div>
